...
def test_chunks_each_fit_the_budget():
    ...
    for piece in chunks:
        ...
        # A lone file may exceed the budget on its own; a chunk of several may not.
...
def test_multi_pass_review_merges_findings(tmp_path):
    ...
    class Counting(StubLLM):
        ...
        def complete(self, system, user):
            Counting.calls += 1
            # Answer about a file this pass was actually shown, the way a real
            # model would; naming a file from another chunk would be a
            # hallucination and correctly discarded.
