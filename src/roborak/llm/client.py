...
# Conservative prompt budgets, leaving room for the completion. Only consulted
# when litellm cannot report a window for the model.
...
class LLMClient:
    ...
    def __post_init__(self) -> None:
        # litellm is slow to import and noisy by default; do it once, lazily.
        import litellm

        litellm.suppress_debug_info = True
        litellm.drop_params = True  # tolerate params a given provider lacks
    ...
    def context_budget(self) -> int:
        ...
        # Leave headroom for the completion and for prompt scaffolding.
